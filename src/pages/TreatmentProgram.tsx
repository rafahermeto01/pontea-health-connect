...
export default function TreatmentProgram() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 relative pb-24 md:pb-0">
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-teal-50 to-white py-8 px-5 md:py-24 md:px-4">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <Button
            size="lg"
            className="bg-teal-600 hover:bg-teal-700 text-white rounded-xl text-lg px-8 py-4 min-h-[56px] h-auto hidden md:inline-flex font-semibold"
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center md:text-left flex flex-col items-center md:items-start p-5">
      ...
      <section className="py-8 bg-slate-50">
        <div className="container mx-auto px-0 md:px-4 max-w-4xl">
          <div className="bg-teal-50 border border-teal-200 rounded-2xl p-4 md:p-8 flex items-start gap-4 mx-4 md:mx-0">
            <div className="text-teal-600 shrink-0 mt-1">
              <ShieldCheck className="w-8 h-8" />
            </div>
            <div>
              <p className="text-teal-900 font-medium text-sm md:text-lg">
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-left font-semibold text-lg py-4 min-h-[48px]">Como funciona a avaliação?</AccordionTrigger>
            ...
            <AccordionItem value="item-2">
              <AccordionTrigger className="text-left font-semibold text-lg py-4 min-h-[48px]">Quem é o médico que avalia?</AccordionTrigger>
              <AccordionContent className="text-slate-600 text-base">
            ...
            <AccordionItem value="item-3">
              <AccordionTrigger className="text-left font-semibold text-lg py-4 min-h-[48px]">E se eu não for aprovado?</AccordionTrigger>
              <AccordionContent className="text-slate-600 text-base">
            ...
            <AccordionItem value="item-4">
              <AccordionTrigger className="text-left font-semibold text-lg py-4 min-h-[48px]">Como é feita a entrega?</AccordionTrigger>
              <AccordionContent className="text-slate-600 text-base">
            ...
            <AccordionItem value="item-5">
              <AccordionTrigger className="text-left font-semibold text-lg py-4 min-h-[48px]">Posso cancelar a qualquer momento?</AccordionTrigger>
              <AccordionContent className="text-slate-600 text-base">
      ...
      {/* Mobile Fixed CTA */}
      <div className="md:hidden fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-slate-100 shadow-lg z-50">
        <Button
          size="lg"
          className="w-full bg-teal-600 hover:bg-teal-700 text-white rounded-xl text-lg py-4 min-h-[56px] h-auto font-semibold"
          onClick={() => navigate(`/tratamento/${slug}/quiz`)}
        >
          Começar avaliação gratuita
        </Button>
